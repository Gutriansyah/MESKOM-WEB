...
@section('content')
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-8">
                <form action="{{ route('store-penginapan') }}" method="POST" enctype="multipart/form-data" role="form">
                    @csrf
                    @method('POST')
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name="tarif" id="tarif">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name="kontak" id="kontak">
